...
"replay":{"controller_joint_order","initial_joint_tolerance_rad","speed_scale","start_settle_sec","end_settle_sec","feedback_stale_sec","max_joint_velocity_rad_s","max_joint_acceleration_rad_s2","execute_requires_program_running","execute_requires_normal_safety"},
...
def load_config(path: str|Path) -> CollectorConfig:
    ...
    for section, fields in (("gripper",("minimum_command_interval_sec","command_timeout_sec","confirmation_timeout_sec")),("replay",("initial_joint_tolerance_rad","start_settle_sec","end_settle_sec","feedback_stale_sec"))):
